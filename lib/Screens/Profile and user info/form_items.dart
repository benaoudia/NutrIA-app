...
final labels = [
  {
    'label': 'Your height',
    'initial': (PersonalInfoLoaded state) => (state.height == 0 || state.height == null) ? '' : state.height.toString(),
    'update': (PersonalInfoCubit cubit, String val) =>
        cubit.updateHeight(int.tryParse(val) ?? 0),
  },
  {
    'label': 'Your weight',
    'initial': (PersonalInfoLoaded state) => (state.weight == 0 || state.weight == null) ? '' : state.weight.toString(),
    'update': (PersonalInfoCubit cubit, String val) =>
